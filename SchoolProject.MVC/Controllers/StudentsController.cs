...
namespace SchoolProject.MVC.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Age,DepartmentId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,Age,DepartmentId")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
